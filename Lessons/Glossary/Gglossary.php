...
<?php include("../../menulessonpage.php");?>
	...
	<div class="userContentOne">
		...
		<div class="letter">
			<h1 class="lettrine">G</h1>
		</div>

		<div class="arrowWrapper">
			<input type="button-arrow" name="arrow-left" class="arrow-left" onclick= window.location.href="/./Lessons/Glossary/Fglossary.php">
			<input type="button-arrow" name="arrow-right" class="arrow-right" onclick= window.location.href="/./Lessons/Glossary/Hglossary.php">
		</div>
