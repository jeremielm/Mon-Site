...
<body class="glossary">
	...
	<div class="userContentOne">
		...
		<div class="letter">
			<h1 class="lettrine">N</h1>
		</div>

		<div class="arrowWrapper">
			<input type="button-arrow" name="arrow-left" class="arrow-left" onclick= window.location.href="/./Lessons/Glossary/Mglossary.php">
			<input type="button-arrow" name="arrow-right" class="arrow-right" onclick= window.location.href="/./Lessons/Glossary/Oglossary.php">
		</div>
