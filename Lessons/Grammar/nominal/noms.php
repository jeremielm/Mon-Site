...
<body class="grammar">
		...
		<header>
		<h1 class="head">Noms et quantités</h1>
	...
	<div class="userContentOne">
		...
		<div class="titleOne"><h1 class="grammarTitleOne">Noms et quantités</h1></div>

		<div class="domaineNominal">
			<div class="cardOne">
				<img class="img-responsive" src="/./img/bigbird.png">
				<a href="">Dénombrables</a>
			</div>

			<div class="cardOne">
				<img class="img-responsive" src="/./img/bigbird.png">
				<a href="">Indénombrables</a>
			</div>
		</div>
