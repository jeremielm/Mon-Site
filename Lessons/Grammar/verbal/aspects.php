...
<body class="grammar">
	...
	<div class="userContentOne">
		...
		<div class="titleTwo"><h1 class="grammarTitleTwo">Les aspects</h1></div>

		<div class="domaineVerbal">

			<div class="cardTwo">
				<img class="img-responsive" src="/./img/bigbird.png">
				<a href="/Lessons/Grammar/verbal/being.php">BE + ING</a>
			</div>

			<div class="cardTwo">
				<img class="img-responsive" src="/./img/bigbird.png">
				<a href="/Lessons/Grammar/verbal/haveen.php">HAVE + EN</a>
			</div>

			<div class="cardTwo">
				<img class="img-responsive" src="/./img/bigbird.png">
				<a href="">HAVE + EN + BE + ING</a>
			</div>

			<div class="cardTwo">
				<img class="img-responsive" src="/./img/bigbird.png">
				<a href="">L'expression de l'avenir</a>
			</div>
