...
<body class="grammar">
	...
	<div class="userContentOne">
		...
		<div class="titleTwo"><h1 class="grammarTitleTwo">La phrase</h1></div>

		<div class="domaineVerbal">

			<div class="cardTwo">
				<img class="img-responsive" src="/./img/bigbird.png">
				<a href="/Lessons/Grammar/verbal/phrasesimple.php">La phrase simple</a>
			</div>

			<div class="cardTwo">
				<img class="img-responsive" src="/./img/bigbird.png">
				<a href="/Lessons/Grammar/verbal/coordination.php">la phrase complexe</a>
			</div>
