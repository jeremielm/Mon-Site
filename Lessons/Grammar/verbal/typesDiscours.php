...
<html lang="eng">
<head>
	<title>Les types de discours</title>
	<meta charset="utf-8">
...
<body class="grammar">
	...
	<header>
		<h1 class="head">Les types de discours</h1>
	...
	<div class="userContentOne">
		...
		<div class="titleTwo"><h1 class="grammarTitleTwo">Les types de discours</h1></div>

		<div class="domaineVerbal">

			<div class="cardTwo">
				<img class="img-responsive" src="/./img/bigbird.png">
				<a href="">Discours direct</a>
			</div>

			<div class="cardTwo">
				<img class="img-responsive" src="/./img/bigbird.png">
				<a href="">Discours indirect</a>
			</div>
